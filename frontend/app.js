...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function applyRoleNavVisibility(role) {
        ...
        if (role === "EMPLOYEE") {
            document.querySelectorAll("[data-role-section='ADMIN'], [data-role-item='ADMIN'], [data-role-section='SBU'], [data-role-item='SBU'], [data-role-section='HR'], [data-role-item='HR'], [data-role-section='FINANCE'], [data-role-item='FINANCE']").forEach(el => el.style.display = "none");
        } else if (role === "SBU") {
